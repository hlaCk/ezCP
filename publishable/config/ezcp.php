...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify ezcp user configs
    |
    */
    ...
    'user' => [
        ...
        // However make sure the appointed class must ready to use before installing ezcp.
        // Otherwise `php artisan ezcp:install` will fail with class not found error.
        'namespace'                    => null,
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify ezcp controller settings
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify ezcp database settings
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify if you want ezCP to ship with support for
    ...
    */
    ...
    'dashboard' => [
        ...
        'navbar_items' => [
            ...
            'ezcp::generic.home' => [
                'route'        => '/',
                'icon_class'   => 'ezcp-home',
                'target_blank' => true,
            ],
            'ezcp::generic.logout' => [
                'route'      => 'ezcp.logout',
                'icon_class' => 'ezcp-power',
            ],
        ],
    ...
    |--------------------------------------------------------------------------
    |
    | When a change happens on ezCP, we can automate some routines.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you change some of the ezCP UI settings.
    |
    */
