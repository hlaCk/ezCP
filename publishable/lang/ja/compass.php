...
return [
    'welcome'                => 'ezCPコンパスへようこそ。 すべての素晴らしいアプリケーションには正しい方向を示すコンパスが必要です。
        このセクションでは、アプリケーションを構築する際に役立つ多くのリソースと管理タスクを紹介します。',
    'links'         => [
        'title'                 => 'リンク',
        'documentation'         => 'ドキュメント(英語サイト)',
        'ezcp_homepage'      => 'ezCP ホームページ (英語サイト)',
        'ezcp_hooks'         => 'ezCP フック (英語サイト)',
    ],
    'commands'      => [
        'title'                 => 'コマンド',
        'text'                  => 'ezCPからArtisanコマンドを実行します。',
        'clear_output'          => '出力をクリア',
    ...
    'resources'     => [
        'title'                 => 'リソース',
        'text'                  => 'ezCPリソースはより素早く探しものをする手助けとなります。',
    ...
    'fonts'         => [
        'title'                 => 'フォント',
        'font_class'            => 'ezCP Fonts Class マッピング',
        'font_character'        => 'ezCP Fonts Character マッピング',
    ],
];
