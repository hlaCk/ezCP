...
return [
    'welcome'                => '
    به قطب نمای ezcp خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'ezcp_homepage'      => 'صفحه اصلی ezcp',
        'ezcp_hooks'         => 'هوک های ezcp',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از ezcp',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع ezCP برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت ezCP',
        'font_character'        => 'نقشه کاراکترهای فونت ezCP',
    ],
];
