...
return [
    'welcome'                => 'بەخێربێیت بۆ قیبلەنمای ڤۆیەیجەر (ezCP). هەموو ئەپڵیکەیشنێک پێویستی بە قیبلەنمایەکە بۆ نیشاندانی ڕێی ڕاست.
    ...
    'links'         => [
        ...
        'ezcp_homepage'      => 'پەڕەی سەرەتای ڤۆیەیجەر (ezCP)',
        'ezcp_hooks'         => 'هووکەکانی ڤۆیەیجەر (ezCP)',
    ],
    'commands'      => [
        'title'                 => 'ناونیشان',
