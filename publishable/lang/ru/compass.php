...
return [
    'welcome'                => 'Добро пожаловать в ezCP Compass. Каждое хорошее приложение нуждается в компасе, чтобы указать им в правильном направлении.
     В этом разделе вы найдете много ресурсов и административных задач, которые помогут вам в создании вашего приложения.',
    'links'         => [
        'title'                 => 'Ссылки',
        'documentation'         => 'Документация',
        'ezcp_homepage'      => 'Страница ezCP',
        'ezcp_hooks'         => 'Хуки ezCP',
    ],
    'commands'      => [
        'title'                 => 'Команды',
        'text'                  => 'Запустите команду Artisan от ezCP.',
    ...
    'resources'     => [
        'title'                 => 'Ресурсы',
        'text'                  => 'Ресурсы ezCP, которые помогут вам найти вещи быстрее.',
    ...
    'fonts'         => [
        'title'                 => 'Шрифты',
        'font_class'            => 'Карта классов шрифта ezCP',
        'font_character'        => 'Карта символов шрифта ezCP',
    ],
];
