...
return [
    'welcome'                => 'Bem-vindo à Bússola do ezCP. Todo bom app precisa de uma bússola para mostrar a direção correta.
    Nessa seção você encontrará muitos recursos e tarefas administativas que o guiará na construção de sua aplicação.',
    'links'         => [
        'title'                 => 'Links',
        'documentation'         => 'Documentação',
        'ezcp_homepage'      => 'Página Inicial do ezCP',
        'ezcp_hooks'         => 'ezCP Hooks',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Rodar Comandos Artisan a partir do ezCP.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Os Recursos ezCP ajudará você encontrar as coisas mais rápido.',
    ...
    'fonts'         => [
        'title'                 => 'Fontes',
        'font_class'            => 'Mapa de Classe de Fonte ezCP',
        'font_character'        => 'Mapa de Caracteres de Fonte ezCP',
    ],
];
