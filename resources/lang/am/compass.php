...
return [
    'welcome'                => 'Բարի գալուստ ezCP կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'ezcp_homepage'      => 'ezCP Գլխավոր էջ',
        'ezcp_hooks'         => 'ezCP Hooks',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները ezCP-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'ezCP-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'ezCP-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'ezCP-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
