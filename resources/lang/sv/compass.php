...
return [
    'welcome'           => 'Välkommen till ezCP Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'ezcp_homepage'      => 'ezCP Hemsida',
        'ezcp_hooks'         => 'ezCP Hooks',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från ezCP.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'ezCP resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'ezCP Typsnitt Klasser',
        'font_character'        => 'ezCP Typsnitt Tecken',
    ],
];
