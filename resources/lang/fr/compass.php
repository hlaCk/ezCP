...
return [
    'welcome'                => 'Bienvenue sur ezCP Compass. Chaque bonne nouvelle application ont besoin d\'une boussole pour se diriger dans la bonne direction.
    Dans cette section, vous trouverez plusieurs ressources et tâches administrative afin de vous guider lors de la création de votre application',
        ...
        'Welcome to the ezCP Compass. Every good app needs a compass to point them in the right direction.
    ...
    'links'         => [
        ...
        'ezcp_homepage'      => 'ezCP Homepage',
        'ezcp_hooks'         => 'ezCP Hooks',
    ],
    'commands'      => [
        'title'                 => 'Commandes',
        'text'                  => 'Lancer les Commandes artisan depuis ezCP.',
    ...
    'resources'     => [
        'title'                 => 'Resources',
        'text'                  => 'Ressources ezCP pour vous aider a rechercher certaines chose plus vite.',
    ...
    'fonts'         => [
        ...
        'font_class'            => 'Classe de correspondance à la police ezCP',
        'font_character'        => 'Charactère de correspondance à la police ezCP',
    ],
];
