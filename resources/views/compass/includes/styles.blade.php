<style type="text/css">
        .ezcp .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .ezcp .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .ezcp .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/packages/hlack/ezcp/publishable/assets/images/bg.jpg);
        ...
        .ezcp .compass .nav-tabs > li > a:hover{
        ...
        .ezcp-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .ezcp-link span.resource_label:hover i{
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .ezcp #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .ezcp #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
