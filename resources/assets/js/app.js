...
require('./ezcp_tinymce');
require('./ezcp_ace_editor');
...
$(document).ready(function () {
    ...
    $(".hamburger, .navbar-expand-toggle").on('click', function () {
        ...
        if ($(this).hasClass('is-active')) {
            window.localStorage.setItem('ezcp.stickySidebar', true);
        } else {
            window.localStorage.setItem('ezcp.stickySidebar', false);
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-collapse"]', function (e) {
        ...
        if (!$this.hasClass('panel-collapsed')) {
            ...
            $this.removeClass('ezcp-angle-up').addClass('ezcp-angle-down');
        } else {
            $this.parents('.panel').find('.panel-body').slideDown();
            $this.removeClass('panel-collapsed');
            $this.removeClass('ezcp-angle-down').addClass('ezcp-angle-up');
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-fullscreen"]', function (e) {
        e.preventDefault();
        var $this = $(this);
        if (!$this.hasClass('ezcp-resize-full')) {
            $this.removeClass('ezcp-resize-small').addClass('ezcp-resize-full');
        } else {
            $this.removeClass('ezcp-resize-full').addClass('ezcp-resize-small');
        }
