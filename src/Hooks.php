...
class Hooks
{
     ...
     * @param $name
     *
     * @throws \hlaCk\ezCP\Exceptions\HookAlreadyInstalledException
     */
     ...
     * @param $keep boolean
     *
     * @throws \hlaCk\ezCP\Exceptions\HookNotInstalledException
     */
     ...
     * @param bool        $force
     *
     * @throws \hlaCk\ezCP\Exceptions\HookNotFoundException
     * @throws \hlaCk\ezCP\Exceptions\HookNotInstalledException
     *
     * @return bool
     */
     ...
     * @throws \hlaCk\ezCP\Exceptions\HookNotFoundException
     * @throws \hlaCk\ezCP\Exceptions\HookNotInstalledException
     * @throws \hlaCk\ezCP\Exceptions\HookAlreadyEnabledException
     */
     ...
     *
     * @throws \hlaCk\ezCP\Exceptions\HookNotFoundException
     * @throws \hlaCk\ezCP\Exceptions\HookNotEnabledException
     * @throws \hlaCk\ezCP\Exceptions\HookNotInstalledException
     */
     ...
     * @param $name
     *
     * @throws \hlaCk\ezCP\Exceptions\HookAlreadyExistsException
     */
