...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'ezcp:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from ezCP.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('packages/hlack/ezcp/src/Http/Controllers'));
        $namespace = config('ezcp.controllers.namespace', 'hlaCk\\ezCP\\Http\\Controllers');
        ...
        $this->info('Published ezCP controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/packages/hlack/ezcp/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'hlaCk\\ezCP\\Http\\Controllers\\'.$class,
            $content
        );
