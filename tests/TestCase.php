...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup ezCP configuration
        $app['config']->set('ezcp.user.namespace', User::class);
    ...
    {
        $this->artisan('ezcp:install', ['--with-dummy' => $this->withDummy]);

        app(ezCPServiceProvider::class, ['app' => $this->app])->loadAuth();
