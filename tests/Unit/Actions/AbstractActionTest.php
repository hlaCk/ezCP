...
namespace hlaCk\ezCP\Tests\Unit\Actions;

use hlaCk\ezCP\Actions\AbstractAction;
...
class AbstractActionTest extends TestCase
{
     ...
     *
     * @var \hlaCk\ezCP\Models\DataType
     */
    ...
    public function setUp(): void
    {
        ...
        $this->userDataType = ezCP::model('DataType')->where('name', 'users')->first();
