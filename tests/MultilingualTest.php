...
use hlaCk\ezCP\Translator\Collection;
...
class MultilingualTest extends TestCase
{
    public function setUp(): void
    {
        ...
        config()->set('ezcp.multilingual.locales', ['en', 'da']);

        // Turn on multilingual
        config()->set('ezcp.multilingual.enabled', true);
    }

    public function testCheckingModelIsTranslatable()
    {
        $this->assertTrue(ezCP::translatable(TranslatableModel::class));
        $this->assertTrue(ezCP::translatable(ActuallyTranslatableModel::class));
    }

    public function testCheckingModelIsNotTranslatable()
    {
        $this->assertFalse(ezCP::translatable(NotTranslatableModel::class));
        $this->assertFalse(ezCP::translatable(StillNotTranslatableModel::class));
    }
